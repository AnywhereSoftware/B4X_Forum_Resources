...
void LoRaClass::dumpRegisters(byte* DumpOut)
{
  for (int i = 0; i < 128; i++) {
//    out.print("0x");
//    out.print(i, HEX);
...
void LoRaClass::serialPrintln(String txt)
   {
   Serial.println(txt); 
   }
void LoRaClass::serialPrint(String txt)
   {
   Serial.print(txt); 
   }   
//added for B4R
void LoRaClass::processing()  {
   if (IRQFlag== 1) {handleDio0Rise(); IRQFlag = 0; } 
   }
