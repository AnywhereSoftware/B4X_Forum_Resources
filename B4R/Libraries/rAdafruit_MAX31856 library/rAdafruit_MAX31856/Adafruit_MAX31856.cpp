...
*/
/**************************************************************************/
Adafruit_MAX31856::max31856_conversion_mode_t Adafruit_MAX31856::getConversionMode(void) {
...
*/
/**************************************************************************/
Adafruit_MAX31856::max31856_thermocoupletype_t Adafruit_MAX31856::getThermocoupleType(void) {
  uint8_t t = readRegister8(MAX31856_CR1_REG);
  t &= 0x0F;

  return (Adafruit_MAX31856::max31856_thermocoupletype_t)(t);
}
