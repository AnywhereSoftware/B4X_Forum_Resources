...
// #include <DNSServer.h>
    ...
    //~Version: 1.0 
    //~Author - 
    //~Libray from https://github.com/me-no-dev/AsyncTCP
...
namespace B4R {
    ...
    class B4RAsyncClient
    {
        ...
        public:
            ...
            void Initialize();
            //creation new client in case of AsybcTCP Client configuration
            uint32_t newClient();
