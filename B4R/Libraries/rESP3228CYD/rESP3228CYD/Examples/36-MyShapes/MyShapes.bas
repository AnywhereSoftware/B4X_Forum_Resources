...
'Each method has an ESP3228CYD instance as first argument and must be declared as public.
...
Public Sub DrawHeading(lcd As ESP3228CYD, text As String)
...
Public Sub DrawFooter(lcd As ESP3228CYD, text As String)
...
Public Sub DrawPixel8(lcd As ESP3228CYD, x As Int, y As Int, color As ULong)
	Dim size As Byte = 8
...
'</code>
Public Sub DrawIcon(lcd As ESP3228CYD, x As UInt, y As UInt, size As Byte, icon() As Byte, color As ULong, bgcolor As ULong)
...
Public Sub DrawButtonRound(lcd As ESP3228CYD, x As Long, y As Long, w As Long, h As Long, text As String, textcolor As ULong, color As ULong)
