...
//~dependson: FirebaseInstallations.framework.3
//~dependson: GoogleAppMeasurement.framework.3
//~dependson: GoogleDataTransport.framework.3
//~dependson: GoogleDataTransportCCTSupport.framework.3
//~dependson: GoogleUtilities.framework.3
//~dependson: PromisesObjC.framework.3
