...
' fredo v1
' --> https://www.b4x.com/android/forum/threads/verify-receipts-for-auto-renewable-subscriptions.132432/
' ------------------------------------
'
...
#region --- Returned data in j.GetString: 
	...
	'				 "quantity":"1",
	'				 "unique_vendor_identifier":"FB46F756-567F-4156-4FB4-FC2F21ABCDE",
	'				 "bvrs":"1.4.54",
	...
	'				 "item_id":"1568860737",
	'				 "unique_identifier":"fddd233c4479d036f3c44a79298e128683779f60",
	...
	'				 {"original_purchase_date_pst":"2021-05-13 23:20:48 America/Los_Angeles",
	'				 "quantity":"1",
	'				 "unique_vendor_identifier":"FB46F756-557F-4D56-4FB4-FC2F21ABCDE",
	'				 "bvrs":"1.4.54",
	...
	'				 "is_trial_period":"false",
	'				 "item_id":"1568860951",
	'				 "unique_identifier":"fddd233c4479d036f3aaaaaa298e154383779f6a",
...
' ---------- ---------- ---------- ---------- ---------- 
#if you_need_the_php_file:

   The following is the content of the php file. 
   Put it to your secure server as  "recvali.php"

<?php
// Created by: 	Yvon Steinthal  --> https://www.b4x.com/android/forum/threads/in-app-subscription-question.101278/post-636275
$json['receipt-data'] = $_GET['receipt'];
$json['password'] = "yyyyyy-your-app-secret-here-yyyyyyyy";
