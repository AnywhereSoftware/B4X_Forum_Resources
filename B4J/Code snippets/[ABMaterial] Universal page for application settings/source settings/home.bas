...
public Sub BuildPage()
	...
	page.PageTitle = "Demo settings"
	page.PageDescription = "Demo settings"
	page.PageKeywords = ""
	...
	page.AddRowsM(10,True,20,20, "").AddCells12MP(1,0,0,0,0,"")	
...
public Sub ConnectPage()			
	...
	Dim b As ABMButton
	b.InitializeFlat(page,  "btnSet", "","","Open settings", "")
	page.Cell(1,1).AddComponent(b)
	theme.AddLabelTheme("red")
...
Sub btnSet_Clicked(Target As String)
	ABMShared.NavigateToPage(ws,"","../Settings")
End Sub
