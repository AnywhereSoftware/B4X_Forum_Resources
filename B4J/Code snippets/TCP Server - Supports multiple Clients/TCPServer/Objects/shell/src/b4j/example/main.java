...
public static RemoteObject _textfield2 = RemoteObject.declareNull("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");
...
public static RemoteObject _listenport = RemoteObject.createImmutable(0);
public static RemoteObject _clients = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
public static RemoteObject _nextclientid = RemoteObject.createImmutable(0);
  public Object[] GetGlobals() {
		return new Object[] {"Button1",main._button1,"Clients",main._clients,"fx",main._fx,"ListenPort",main._listenport,"MainForm",main._mainform,"NextClientId",main._nextclientid,"Server",main._server,"TextField1",main._textfield1,"TextField2",main._textfield2,"xui",main._xui};
}
}