...
Sub Class_Globals
	...
	Type RunDelayedData (Module As Object, SubName As String, Arg() As Object, Delayed As Boolean, Cancelled As Boolean)
End Sub
...
Public Sub CallSubDelayedPlus(Module As Object, SubName As String, Delay As Int) As RunDelayedData
...
Public Sub CallSubDelayedPlus2(Module As Object, SubName As String, Delay As Int, Arg() As Object) As RunDelayedData
	Return PlusImpl(Module, SubName, Delay, Arg, True)
End Sub

'Similar to CallSub. This method allows you to set the delay (in milliseconds).
'Note that the sub name must include an underscore if compiled with obfuscation enabled.
Public Sub CallSubPlus(Module As Object, SubName As String, Delay As Int) As RunDelayedData
...
'Note that the sub name must include an underscore if compiled with obfuscation enabled.
'The target sub should have one parameter with a type of Object().
Public Sub CallSubPlus2(Module As Object, SubName As String, Delay As Int, Arg() As Object) As RunDelayedData
	Return PlusImpl(Module, SubName, Delay, Arg, False)
End Sub

Private Sub PlusImpl(Module As Object, SubName As String, Delay As Int, Arg() As Object, delayed As Boolean) As RunDelayedData
