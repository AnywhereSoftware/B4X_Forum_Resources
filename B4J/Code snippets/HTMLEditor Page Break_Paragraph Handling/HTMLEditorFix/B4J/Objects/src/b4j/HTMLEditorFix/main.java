...
public static BA ba;
static {
		ba = new  anywheresoftware.b4a.shell.ShellBA("b4j.HTMLEditorFix", "b4j.HTMLEditorFix.main", null);
		ba.loadHtSubs(main.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			anywheresoftware.b4a.shell.ShellBA.delegateBA = new anywheresoftware.b4j.objects.FxBA("b4j.HTMLEditorFix", null, null);
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.HTMLEditorFix.main", ba);
		}
	}
...
b4j.HTMLEditorFix.b4xpagesmanager _pagesmanager = null;
...
_pagesmanager = new b4j.HTMLEditorFix.b4xpagesmanager();
...
_b4xpages._delegate /*b4j.HTMLEditorFix.b4xpagesdelegator*/ ._mainform_closed /*String*/ (null);
...
_b4xpages._delegate /*b4j.HTMLEditorFix.b4xpagesdelegator*/ ._mainform_closerequest /*String*/ (null,_eventdata);
...
_b4xpages._delegate /*b4j.HTMLEditorFix.b4xpagesdelegator*/ ._mainform_focuschanged /*String*/ (null,_hasfocus);
...
_b4xpages._delegate /*b4j.HTMLEditorFix.b4xpagesdelegator*/ ._mainform_iconifiedchanged /*String*/ (null,_iconified);
...
_b4xpages._delegate /*b4j.HTMLEditorFix.b4xpagesdelegator*/ ._mainform_resize /*String*/ (null,_width,_height);
