...
if (RapidSub.canDelegate("addpage")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","addpage", _id, _b4xpage);}
...
Debug.JustUpdateDeviceLine();
_getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_addpage" /*RemoteObject*/ ,(Object)(_id),(Object)(_b4xpage));
...
if (RapidSub.canDelegate("addpageandcreate")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","addpageandcreate", _id, _b4xpage);}
Debug.locals.put("Id", _id);
Debug.locals.put("B4XPage", _b4xpage);
...
Debug.JustUpdateDeviceLine();
_getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_addpageandcreate" /*RemoteObject*/ ,(Object)(_id),(Object)(_b4xpage));
...
if (RapidSub.canDelegate("closepage")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","closepage", _b4xpage);}
Debug.locals.put("B4XPage", _b4xpage);
...
Debug.JustUpdateDeviceLine();
_getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_closepage" /*RemoteObject*/ ,(Object)(_b4xpage));
...
if (RapidSub.canDelegate("getmanager")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","getmanager");}
...
if (RapidSub.canDelegate("getnativeparent")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","getnativeparent", _b4xpage);}
Debug.locals.put("B4XPage", _b4xpage);
...
Debug.JustUpdateDeviceLine();
if (true) return _getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_findpifromb4xpage" /*RemoteObject*/ ,(Object)(_b4xpage)).getField(false,"Parent" /*RemoteObject*/ ).getField(false,"NativeType" /*RemoteObject*/ );
...
if (RapidSub.canDelegate("getpage")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","getpage", _id);}
Debug.locals.put("Id", _id);
...
Debug.JustUpdateDeviceLine();
if (true) return _getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_getpage" /*RemoteObject*/ ,(Object)(_id));
...
if (RapidSub.canDelegate("getpageid")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","getpageid", _b4xpage);}
Debug.locals.put("B4XPage", _b4xpage);
...
Debug.JustUpdateDeviceLine();
if (true) return _getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_findpifromb4xpage" /*RemoteObject*/ ,(Object)(_b4xpage)).getField(true,"Id" /*RemoteObject*/ );
...
if (RapidSub.canDelegate("internalsetpagesmanager")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","internalsetpagesmanager", _pm);}
...
Debug.JustUpdateDeviceLine();
b4xpages._delegate.runClassMethod (b4j.HTMLEditorFix.b4xpagesdelegator.class, "_initialize" /*RemoteObject*/ ,b4xpages.ba);
...
if (RapidSub.canDelegate("isinitialized")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","isinitialized");}
...
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToBoolean(RemoteObject.solveBoolean("i",b4xpages._mpm, RemoteObject.createImmutable("b4j.HTMLEditorFix.b4xpagesmanager")));
...
if (RapidSub.canDelegate("mainpage")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","mainpage");}
...
b4xpages._delegate = RemoteObject.createNew ("b4j.HTMLEditorFix.b4xpagesdelegator");
...
if (RapidSub.canDelegate("settitle")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","settitle", _b4xpage, _title);}
Debug.locals.put("B4XPage", _b4xpage);
...
Debug.JustUpdateDeviceLine();
_getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_settitle" /*RemoteObject*/ ,(Object)(_b4xpage),(Object)(_title));
...
if (RapidSub.canDelegate("showpage")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","showpage", _id);}
Debug.locals.put("Id", _id);
 BA.debugLineNum = 50;BA.debugLine="Public Sub ShowPage (Id As String)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 51;BA.debugLine="GetManager.ShowPage(Id)";
Debug.JustUpdateDeviceLine();
_getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_showpage" /*RemoteObject*/ ,(Object)(_id));
...
if (RapidSub.canDelegate("showpageandremovepreviouspages")) { return b4j.HTMLEditorFix.b4xpages.remoteMe.runUserSub(false, "b4xpages","showpageandremovepreviouspages", _id);}
Debug.locals.put("Id", _id);
...
Debug.JustUpdateDeviceLine();
_getmanager().runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_showpageandremovepreviouspages" /*RemoteObject*/ ,(Object)(_id));
