...
try {
		Debug.PushSubsStack("Activity_Pause (b4xpagesdelegator) ","b4xpagesdelegator",8,__ref.getField(false, "ba"),__ref,52);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ).runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_activity_pause" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Activity_Resume (b4xpagesdelegator) ","b4xpagesdelegator",8,__ref.getField(false, "ba"),__ref,48);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ).runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_activity_resume" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Initialize (b4xpagesdelegator) ","b4xpagesdelegator",8,__ref.getField(false, "ba"),__ref,4);
...
try {
		Debug.PushSubsStack("MainForm_Closed (b4xpagesdelegator) ","b4xpagesdelegator",8,__ref.getField(false, "ba"),__ref,13);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ).runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_mainform_closed" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("MainForm_CloseRequest (b4xpagesdelegator) ","b4xpagesdelegator",8,__ref.getField(false, "ba"),__ref,17);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ).runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_mainform_closerequest" /*RemoteObject*/ ,(Object)(_eventdata));
...
try {
		Debug.PushSubsStack("MainForm_FocusChanged (b4xpagesdelegator) ","b4xpagesdelegator",8,__ref.getField(false, "ba"),__ref,9);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ).runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_mainform_focuschanged" /*RemoteObject*/ ,(Object)(_hasfocus));
...
try {
		Debug.PushSubsStack("MainForm_IconifiedChanged (b4xpagesdelegator) ","b4xpagesdelegator",8,__ref.getField(false, "ba"),__ref,21);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ).runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_mainform_iconifiedchanged" /*RemoteObject*/ ,(Object)(_iconified));
...
try {
		Debug.PushSubsStack("MainForm_Resize (b4xpagesdelegator) ","b4xpagesdelegator",8,__ref.getField(false, "ba"),__ref,44);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ).runClassMethod (b4j.HTMLEditorFix.b4xpagesmanager.class, "_mainform_resize" /*RemoteObject*/ ,(Object)(_width),(Object)(_height));
