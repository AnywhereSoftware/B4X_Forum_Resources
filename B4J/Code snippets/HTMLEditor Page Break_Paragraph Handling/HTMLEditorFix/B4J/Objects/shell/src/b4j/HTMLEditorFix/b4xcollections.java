...
public boolean isSingleton() {
    ...
    static {
		...
		remoteMe = RemoteObject.declareNull("b4j.HTMLEditorFix.b4xcollections");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("b4xcollections"), "b4j.HTMLEditorFix.b4xcollections");
	}
...
public static b4j.HTMLEditorFix.b4xpages _b4xpages = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XPages",Debug.moduleToString(b4j.HTMLEditorFix.b4xpages.class),"Main",Debug.moduleToString(b4j.HTMLEditorFix.main.class)};
}
}