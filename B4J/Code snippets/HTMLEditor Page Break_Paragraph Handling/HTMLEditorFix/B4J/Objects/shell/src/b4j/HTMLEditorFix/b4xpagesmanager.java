...
public static RemoteObject _idtob4xpage = RemoteObject.declareNull("b4j.HTMLEditorFix.b4xorderedmap");
public static RemoteObject _rootb4xtopage = RemoteObject.declareNull("b4j.HTMLEditorFix.b4xorderedmap");
public static RemoteObject _mstackofpageids = RemoteObject.declareNull("b4j.HTMLEditorFix.b4xset");
...
public static RemoteObject _mainpage = RemoteObject.declareNull("b4j.HTMLEditorFix.b4xmainpage");
