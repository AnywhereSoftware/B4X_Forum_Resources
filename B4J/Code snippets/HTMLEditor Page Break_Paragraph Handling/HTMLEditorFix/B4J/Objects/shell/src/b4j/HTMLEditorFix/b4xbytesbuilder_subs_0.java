...
Debug.JustUpdateDeviceLine();
_oldlength = __ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_data.getField(true,"length")}, "+",1, 1)));Debug.locals.put("OldLength", _oldlength);Debug.locals.put("OldLength", _oldlength);
...
try {
		Debug.PushSubsStack("Append2 (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,33);
...
Debug.JustUpdateDeviceLine();
_oldlength = __ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_length}, "+",1, 1)));Debug.locals.put("OldLength", _oldlength);Debug.locals.put("OldLength", _oldlength);
...
try {
		Debug.PushSubsStack("Clear (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,39);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("getInternalBuffer (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,104);
...
try {
		Debug.PushSubsStack("getLength (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("IndexOf (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,109);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_indexof2" /*RemoteObject*/ ,(Object)(_searchfor),(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("IndexOf2 (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,114);
...
try {
		Debug.PushSubsStack("Insert (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,45);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_append" /*RemoteObject*/ ,(Object)(_data));
 }else {
 BA.debugLineNum = 50;BA.debugLine="Dim AfterIndex() As Byte = SubArray(Index)";
Debug.JustUpdateDeviceLine();
_afterindex = __ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_subarray" /*RemoteObject*/ ,(Object)(_index));Debug.locals.put("AfterIndex", _afterindex);Debug.locals.put("AfterIndex", _afterindex);
 BA.debugLineNum = 51;BA.debugLine="ChangeLength(mLength + Data.Length)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_data.getField(true,"length")}, "+",1, 1)));
...
try {
		Debug.PushSubsStack("Remove (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,71);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_subarray2" /*RemoteObject*/ ,(Object)(_beginindex),(Object)(_endindex));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
Debug.JustUpdateDeviceLine();
_afterendindex = __ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_subarray" /*RemoteObject*/ ,(Object)(_endindex));Debug.locals.put("AfterEndIndex", _afterendindex);Debug.locals.put("AfterEndIndex", _afterendindex);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),(RemoteObject.solve(new RemoteObject[] {_endindex,_beginindex}, "-",1, 1))}, "-",1, 1)));
...
try {
		Debug.PushSubsStack("Set (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,58);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_changelength" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {_data.getField(true,"length"),_index}, "+",1, 1)));
 };
...
try {
		Debug.PushSubsStack("SubArray (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,82);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_subarray2" /*RemoteObject*/ ,(Object)(_beginindex),(Object)(__ref.getField(true,"_mlength" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("SubArray2 (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,88);
...
try {
		Debug.PushSubsStack("ToArray (b4xbytesbuilder) ","b4xbytesbuilder",4,__ref.getField(false, "ba"),__ref,99);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.HTMLEditorFix.b4xbytesbuilder.class, "_subarray" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
