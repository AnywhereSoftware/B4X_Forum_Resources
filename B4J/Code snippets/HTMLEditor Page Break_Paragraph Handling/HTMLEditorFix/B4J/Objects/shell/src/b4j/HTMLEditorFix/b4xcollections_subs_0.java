...
try {
		Debug.PushSubsStack("CreateBitSet (b4xcollections) ","b4xcollections",5,b4xcollections.ba,b4xcollections.mostCurrent,52);
if (RapidSub.canDelegate("createbitset")) { return b4j.HTMLEditorFix.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createbitset", _size);}
RemoteObject _s = RemoteObject.declareNull("b4j.HTMLEditorFix.b4xbitset");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("b4j.HTMLEditorFix.b4xbitset");Debug.locals.put("s", _s);
 BA.debugLineNum = 54;BA.debugLine="s.Initialize(Size)";
Debug.JustUpdateDeviceLine();
_s.runClassMethod (b4j.HTMLEditorFix.b4xbitset.class, "_initialize" /*RemoteObject*/ ,b4xcollections.ba,(Object)(_size));
...
try {
		Debug.PushSubsStack("CreateOrderedMap (b4xcollections) ","b4xcollections",5,b4xcollections.ba,b4xcollections.mostCurrent,30);
if (RapidSub.canDelegate("createorderedmap")) { return b4j.HTMLEditorFix.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createorderedmap");}
...
try {
		Debug.PushSubsStack("CreateOrderedMap2 (b4xcollections) ","b4xcollections",5,b4xcollections.ba,b4xcollections.mostCurrent,38);
if (RapidSub.canDelegate("createorderedmap2")) { return b4j.HTMLEditorFix.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createorderedmap2", _keys, _values);}
RemoteObject _m = RemoteObject.declareNull("b4j.HTMLEditorFix.b4xorderedmap");
int _i = 0;
...
Debug.JustUpdateDeviceLine();
_m = RemoteObject.createNew ("b4j.HTMLEditorFix.b4xorderedmap");Debug.locals.put("m", _m);
 BA.debugLineNum = 40;BA.debugLine="m.Initialize";
Debug.JustUpdateDeviceLine();
_m.runClassMethod (b4j.HTMLEditorFix.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,b4xcollections.ba);
...
Debug.JustUpdateDeviceLine();
_m.runClassMethod (b4j.HTMLEditorFix.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)(_keys.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),(Object)(_values.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))));
 }
}Debug.locals.put("i", _i);
;
 };
...
try {
		Debug.PushSubsStack("CreateSet (b4xcollections) ","b4xcollections",5,b4xcollections.ba,b4xcollections.mostCurrent,9);
if (RapidSub.canDelegate("createset")) { return b4j.HTMLEditorFix.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createset");}
...
try {
		Debug.PushSubsStack("CreateSet2 (b4xcollections) ","b4xcollections",5,b4xcollections.ba,b4xcollections.mostCurrent,16);
if (RapidSub.canDelegate("createset2")) { return b4j.HTMLEditorFix.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createset2", _values);}
RemoteObject _s = RemoteObject.declareNull("b4j.HTMLEditorFix.b4xset");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("b4j.HTMLEditorFix.b4xset");Debug.locals.put("s", _s);
 BA.debugLineNum = 18;BA.debugLine="s.Initialize";
Debug.JustUpdateDeviceLine();
_s.runClassMethod (b4j.HTMLEditorFix.b4xset.class, "_initialize" /*RemoteObject*/ ,b4xcollections.ba);
...
Debug.JustUpdateDeviceLine();
_s.runClassMethod (b4j.HTMLEditorFix.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(_v));
 }
}Debug.locals.put("v", _v);
;
 };
