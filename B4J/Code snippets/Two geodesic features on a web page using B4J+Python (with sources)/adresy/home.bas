...
public Sub BuildPage()
	...
	ABMShared.BuildNavigationBar(page, "Adres to współrzędne","", "", "", "")
...
public Sub ConnectPage()			
	...
	If File.Exists(File.DirApp, "licznik.txt") Then
		readlicznik
	Else
		licznik = 1
		writelicznik
	...
	opis.Initialize(page, "opis","Konwersja adresu na układy współrzędne PL (stat: "&licznik&")", ABM.SIZE_H5, False, "opis")
	
	Dim inp As ABMInput
	inp.Initialize(page, "inpAdres", ABM.INPUT_TEXT, "Podaj adres", False, "")
	inp.MaxCharacters = 200
	inp.SetTooltip("np. Radomsko Narutowicza 2", ABM.TOOLTIP_BOTTOM, 300)
	...
	page.Cell(3,1).AddComponent(out)
	page.Row(3).UseTheme("out")
...
Sub inpAdres_EnterPressed(value As String)
...
Sub readlicznik
	licznik = File.ReadString(File.DirApp,"licznik.txt")
End Sub

Sub writelicznik
	File.WriteString(File.DirApp , "licznik.txt", licznik)
End Sub