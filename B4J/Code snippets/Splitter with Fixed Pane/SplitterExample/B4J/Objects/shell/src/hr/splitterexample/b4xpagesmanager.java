...
public static RemoteObject _idtob4xpage = RemoteObject.declareNull("hr.splitterexample.b4xorderedmap");
public static RemoteObject _rootb4xtopage = RemoteObject.declareNull("hr.splitterexample.b4xorderedmap");
public static RemoteObject _mstackofpageids = RemoteObject.declareNull("hr.splitterexample.b4xset");
...
public static RemoteObject _mainpage = RemoteObject.declareNull("hr.splitterexample.b4xmainpage");
