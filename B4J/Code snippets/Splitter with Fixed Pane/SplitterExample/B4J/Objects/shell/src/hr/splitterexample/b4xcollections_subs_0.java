...
if (RapidSub.canDelegate("createbitset")) { return hr.splitterexample.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createbitset", _size);}
RemoteObject _s = RemoteObject.declareNull("hr.splitterexample.b4xbitset");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("hr.splitterexample.b4xbitset");Debug.locals.put("s", _s);
 BA.debugLineNum = 54;BA.debugLine="s.Initialize(Size)";
Debug.JustUpdateDeviceLine();
_s.runClassMethod (hr.splitterexample.b4xbitset.class, "_initialize" /*RemoteObject*/ ,b4xcollections.ba,(Object)(_size));
...
if (RapidSub.canDelegate("createorderedmap")) { return hr.splitterexample.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createorderedmap");}
...
if (RapidSub.canDelegate("createorderedmap2")) { return hr.splitterexample.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createorderedmap2", _keys, _values);}
RemoteObject _m = RemoteObject.declareNull("hr.splitterexample.b4xorderedmap");
int _i = 0;
...
Debug.JustUpdateDeviceLine();
_m = RemoteObject.createNew ("hr.splitterexample.b4xorderedmap");Debug.locals.put("m", _m);
 BA.debugLineNum = 40;BA.debugLine="m.Initialize";
Debug.JustUpdateDeviceLine();
_m.runClassMethod (hr.splitterexample.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,b4xcollections.ba);
...
Debug.JustUpdateDeviceLine();
_m.runClassMethod (hr.splitterexample.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)(_keys.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),(Object)(_values.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))));
 }
}Debug.locals.put("i", _i);
;
 };
...
if (RapidSub.canDelegate("createset")) { return hr.splitterexample.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createset");}
...
if (RapidSub.canDelegate("createset2")) { return hr.splitterexample.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createset2", _values);}
RemoteObject _s = RemoteObject.declareNull("hr.splitterexample.b4xset");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("hr.splitterexample.b4xset");Debug.locals.put("s", _s);
 BA.debugLineNum = 18;BA.debugLine="s.Initialize";
Debug.JustUpdateDeviceLine();
_s.runClassMethod (hr.splitterexample.b4xset.class, "_initialize" /*RemoteObject*/ ,b4xcollections.ba);
...
Debug.JustUpdateDeviceLine();
_s.runClassMethod (hr.splitterexample.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(_v));
 }
}Debug.locals.put("v", _v);
;
 };
