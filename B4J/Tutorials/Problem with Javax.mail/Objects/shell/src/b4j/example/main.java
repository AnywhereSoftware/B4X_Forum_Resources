...
public static RemoteObject _textarea1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
  public Object[] GetGlobals() {
		return new Object[] {"Button1",main._button1,"fx",main._fx,"Label1",main._label1,"MainForm",main._mainform,"TextArea1",main._textarea1,"xui",main._xui};
}
}