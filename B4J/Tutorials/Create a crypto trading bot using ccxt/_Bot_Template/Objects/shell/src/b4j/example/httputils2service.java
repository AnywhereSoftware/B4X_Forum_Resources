...
public static b4j.example.test_ui _test_ui = null;
  public Object[] GetGlobals() {
		return new Object[] {"Calc",Debug.moduleToString(b4j.example.calc.class),"ccxt",Debug.moduleToString(b4j.example.ccxt.class),"CSSUtils",httputils2service._cssutils,"hc",httputils2service._hc,"Main",Debug.moduleToString(b4j.example.main.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder,"test_ui",Debug.moduleToString(b4j.example.test_ui.class)};
}
}