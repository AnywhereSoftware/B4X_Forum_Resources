...
public static RemoteObject _pyworker = RemoteObject.declareNull("b4j.example.pybridgeworker");
public static b4j.example.b4xcollections _b4xcollections = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4j.example.b4xcollections.class),"PyWorker",main._pyworker,"srvr",main._srvr};
}
}