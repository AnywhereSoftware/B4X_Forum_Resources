### Medusa Clocks with JavaObject by Johan Schoeman
### 08/16/2025
[B4X Forum - B4J - Tutorials](https://www.b4x.com/android/forum/threads/168255/)

Not meant to take anything away from [USER=125673]@teddybear[/USER] post [**here**](https://www.b4x.com/android/forum/threads/b4j-make-good-use-of-the-jgauge-library-clock-control.168087/) but thought I would give the clock a shot by using JavaObject. The attached B4J project creates the 16 different clock "skins" within the Medusa Library (medusa-8.0-jar). You need to find the Jar on the web, download it, and then copy it to your B4J additional library folder. I am pointing to Java 14 with this B4J project but earlier versions will in all probability also work.  
...
![](https://www.b4x.com/android/forum/attachments/166064)