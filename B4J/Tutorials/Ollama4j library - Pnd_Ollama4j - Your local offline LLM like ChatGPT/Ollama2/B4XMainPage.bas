...
Private Sub btnSend_Click
	...
	Dim dog As String = File.DirApp & "\dog.jpg"
	'Dim meerkat As String = File.DirApp & "\meerkat.jpg"		
	ListOfFiles.Add(dog)
	'ListOfFiles.Add(meerkat)

	btnSend.Enabled = False
	txtOutput.Text = txtOutput.Text & "*** " & txtInput.Text & " ***" & CRLF
	Dim Result As Pnd_OllamaResult = Main.Ollama.GenerateWithImageFiles(cBox.Value, txtInput.Text, ListOfFiles)
