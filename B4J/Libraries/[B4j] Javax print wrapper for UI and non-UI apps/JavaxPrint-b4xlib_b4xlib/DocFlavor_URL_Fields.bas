...
Public Sub AUTOSENSE As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub GIF As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub JPEG As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub PCL As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub PDF As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub PNG As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub POSTSCRIPT As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_HTML_HOST As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_HTML_US_ASCII As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_HTML_UTF_16 As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_HTML_UTF_16BE As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_HTML_UTF_16LE As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_HTML_UTF_8 As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_PLAIN_HOST As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_PLAIN_US_ASCII As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_PLAIN_UTF_16 As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_PLAIN_UTF_16BE As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_PLAIN_UTF_16LE As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
...
Public Sub TEXT_PLAIN_UTF_8 As DocFlavor_URL
	Dim Wrapper As DocFlavor_URL
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.URL")
