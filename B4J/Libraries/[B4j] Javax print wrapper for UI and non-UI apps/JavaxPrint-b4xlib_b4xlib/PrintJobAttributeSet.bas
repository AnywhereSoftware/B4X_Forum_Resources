...
'<link>Javadoc|https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/print/attribute/PrintRequestAttribute.html</link>
...
Public Sub Initialize
	Tjo.InitializeNewInstance("javax.print.attribute.HashPrintJobAttributeSet",Null)
End Sub
...
Public Sub AddAll(Atts As PrintJobAttributeSet) As Boolean
...
Public Sub Equals(PJA As PrintJobAttributeSet) As Boolean
	Return Tjo.RunMethod("equals",Array As Object(PJA.GetObject))
End Sub
