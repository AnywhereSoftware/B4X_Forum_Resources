...
Public Sub AUTOSENSE As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub GIF As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub JPEG As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub PCL As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub PDF As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub PNG As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub POSTSCRIPT As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_HTML_HOST As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_HTML_US_ASCII As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_HTML_UTF_16 As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_HTML_UTF_16BE As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_HTML_UTF_16LE As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_HTML_UTF_8 As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_PLAIN_HOST As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_PLAIN_US_ASCII As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_PLAIN_UTF_16 As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_PLAIN_UTF_16BE As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_PLAIN_UTF_16LE As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
...
Public Sub TEXT_PLAIN_UTF_8 As DocFlavor_INPUT_STREAM
	Dim Wrapper As DocFlavor_INPUT_STREAM
	Wrapper.Initialize
	Dim Tjo As JavaObject
	Tjo.InitializeStatic("javax.print.DocFlavor.INPUT_STREAM")
