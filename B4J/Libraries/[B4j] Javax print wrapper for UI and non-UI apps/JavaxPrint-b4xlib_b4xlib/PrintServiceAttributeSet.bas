...
#IgnoreWarnings:12
'Class Module
'<link>PrintServiceAttributes|https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/print/attribute/PrintServiceAttribute.html </link>
'Attributes handled by PrintServiceAttributeSet :
'	ColorSupported, 
'	PagesPerMinute, PagesPerMinuteColor, PDLOverrideSupported, 
'	PrinterInfo, PrinterIsAcceptingJobs, PrinterLocation, 
'	PrinterMakeAndModel, PrinterMessageFromOperator, 
'	PrinterMoreInfo, PrinterMoreInfoManufacturer, PrinterName, 
'	PrinterState, 'PrinterStateReasons, PrinterURI, QueuedJobCount
Sub Class_Globals
...
Public Sub Initialize
	Tjo.InitializeNewInstance("javax.print.attribute.HashPrintServiceAttributeSet",Null)
End Sub
...
Public Sub AddAll(Atts As PrintServiceAttributeSet) As Boolean
...
Public Sub Equals(TObject As PrintServiceAttributeSet) As Boolean
