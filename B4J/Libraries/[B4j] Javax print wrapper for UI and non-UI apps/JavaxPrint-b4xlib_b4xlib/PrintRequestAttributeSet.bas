...
#IgnoreWarnings:12
'Class Module
'<link>PrintRequestAttributes|https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/javax/print/attribute/PrintRequestAttribute.html </link>
'Attributes Handled by PrintRequestAttributeSet :
'	Chromaticity, Copies, 
'	Destination, DialogOwner, DialogTypeSelection, 
'	Fidelity, Finishings, 
'	JobHoldUntil, JobImpressions, JobKOctets, 
'	JobMediaSheets, JobName, 
'	JobPriority, JobSheets, 
'	Media, MediaName, MediaPrintableArea, MediaSizeName, MediaTray, MultipleDocumentHandling, 
'	NumberUp, OrientationRequested, 
'	PageRanges, PresentationDirection, PrinterResolution, PrintQuality, 
'	RequestingUserName, 
'	SheetCollate, Sides
Sub Class_Globals
...
Public Sub Initialize
	Tjo.InitializeNewInstance("javax.print.attribute.HashPrintRequestAttributeSet",Null)
End Sub
...
Public Sub AddAll(Atts As PrintRequestAttributeSet) As Boolean
...
Public Sub Equals(TObject As PrintRequestAttributeSet) As Boolean
