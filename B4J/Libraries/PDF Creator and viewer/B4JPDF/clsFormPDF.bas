...
Private Sub LoadButtons(acustombuttons As List)
	...
	Dim buttons As List
	buttons.Initialize
	buttons.Add(CreateMap("image":"F100","tag":"first","hint":"F2 - Première page"))
	buttons.Add(CreateMap("image":"F104","tag":"previous","hint":"F3 - Page précédente"))
	buttons.Add(CreateMap("image":"F105","tag":"next","hint":"F4 - Page suivante"))
	buttons.Add(CreateMap("image":"F101","tag":"last","hint":"F5 - Dernière page"))
	buttons.Add(CreateMap("image":"F068","tag":"zoom-","hint":"F6 - Zoom -"))
	buttons.Add(CreateMap("image":"F067","tag":"zoom+","hint":"F7 - Zoom +"))
	buttons.Add(CreateMap("image":"F02F","tag":"print","hint":"F8 - Imprimer"))
	buttons.Add(CreateMap("image":"F0C7","tag":"save","hint":"F9 - Enregistrer en PDF"))
