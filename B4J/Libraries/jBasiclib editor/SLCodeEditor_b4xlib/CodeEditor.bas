...
'Update V1.01
'	Added public panes for Language and Theme Controls to make it easy to hide them.
...
Sub Class_Globals
	...
	Public pnThemes As B4XView
	Public pnLanguage As B4XView
End Sub
...
Public Sub setTheme(Theme As String)
	...
	cbThemes.SelectedIndex = cbThemes.IndexOf(Theme)
	cbThemes_SelectedIndexChanged(cbThemes.IndexOf(Theme))
End Sub
