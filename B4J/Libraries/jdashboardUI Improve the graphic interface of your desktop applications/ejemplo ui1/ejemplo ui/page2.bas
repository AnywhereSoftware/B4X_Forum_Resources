...
Sub show
	...
	jdashboardUtils.ButtonSetImage2(firebasebutton,File.DirAssets,"google_firebase_console_512px.png","#5D5F90","#5D5F90",30,30,"LEFT")
	jdashboardUtils.ButtonSetImage2(playstorebutton,File.DirAssets,"icons8_Google_Play_512px.png","#5D5F90","#5D5F90",30,30,"LEFT")
	jdashboardUtils.ButtonSetImage2(Googlesheetsbutton,File.DirAssets,"icons8_google_sheets_512px.png","#5D5F90","#5D5F90",30,30,"LEFT")
	
jdashboardUtils.ToolTip(Panel21.mBase,"using the firebase notifications api",fx.DefaultFont(14),File.DirAssets,"google_firebase_console_512px.png",30,30)
