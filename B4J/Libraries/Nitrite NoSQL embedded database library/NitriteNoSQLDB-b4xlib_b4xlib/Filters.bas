...
Public Sub ALL As Filter
	Dim JO As JavaObject
	JO.InitializeStatic("org.dizitart.no2.filters.Filters")
...
Public Sub And_(TFilters() As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
	Wrapper.SetObject(Tjo1.RunMethod("and",Array( UnWrapTypedArray(TFilters, "org.dizitart.no2.Filter"))))
	Return Wrapper
End Sub

'return a filter that matches between values Exclusive
Public Sub Btw(FieldName As String,Value1 As Object, Value2 As Object) As Filter
	Return And_(Array(Gte(FieldName,Value1),Lt(FieldName,Value2)))
End Sub
'return a filter that matches between values Inclusive
Public Sub BtwI(FieldName As String,Value1 As Object, Value2 As Object) As Filter
	Return And_(Array(Gte(FieldName,Value1),Lte(FieldName,Value2)))
End Sub
...
Public Sub ElemMatch(Field As String, TFilter As Filter) As Filter
	Dim Filt As Object
...
Public Sub Eq(Field As String, Value As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
...
Public Sub Gt(Field As String, Value As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
...
Public Sub Gte(Field As String, Value As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
	...
	Return Wrapper
End Sub
'Creates an in filter which matches the documents where the value of a field equals the specified value.
Public Sub IsIn(Field As String, Values() As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
...
Public Sub Lt(Field As String, Value As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
...
Public Sub Lte(Field As String, Value As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
...
Public Sub Not_(TFilter As Filter) As Filter
	Dim Filt As Object
	If TFilter.Tag = "ALL" Then
		Filt = Null
	Else
...
Public Sub NotIn(Field As String, Values() As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
...
Public Sub Or_(TFilters() As Object) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
	Wrapper.SetObject(Tjo1.RunMethod("or",Array As Object( UnWrapTypedArray(TFilters, "org.dizitart.no2.Filter"))))
	Return Wrapper
End Sub
'Creates a string filter which provides regular expression capabilities for pattern matching strings in documents.
Public Sub Regex_(Field As String, Value As String) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
...
Public Sub Text(Field As String, Value As String) As Filter
	Dim Tjo1 As JavaObject
	Tjo1.InitializeStatic("org.dizitart.no2.filters.Filters")
	Dim Wrapper As Filter
	Wrapper.Initialize
