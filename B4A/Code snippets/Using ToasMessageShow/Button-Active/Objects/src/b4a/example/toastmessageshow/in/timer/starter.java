...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "b4a.example.toastmessageshow.in.timer", "b4a.example.toastmessageshow.in.timer.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.toastmessageshow.in.timer.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public b4a.example.toastmessageshow.in.timer.main _vv1 = null;
