...
Public Sub Load(xmime As String) As ResumableSub
	Dim cc As ContentChooser
	cc.Initialize("cc")
	
	If xmime="pdf" Then
		cc.Show("application/pdf", "Seleccione un archivo pdf o txt")
	Else
		If xmime = "txt" Then
			cc.Show("text/*", "Seleccione un archivo pdf o txt")
		Else
			If xmime = "epub" Then
				cc.Show("application/epub+zip/*", "Seleccione un archivo epub")
			End If	
		End If
	End If
