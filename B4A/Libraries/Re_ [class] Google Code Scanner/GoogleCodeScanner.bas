...
Public Sub Initialize
	...
	formatmap.put(2048,"PDF417")
	formatmap.put(256,"QR")
	formatmap.put(-1, "Unknown Format")
...
'	builder.RunMethod("enableAutoZoom", Null)
	...
	If o.RunMethod("isSuccessful", Null) Then
		...
		res.display = res.Barcode.RunMethod("getDisplayValue",Null)
		res.format = formatmap.get(res.Barcode.RunMethod("getFormat", Null))
