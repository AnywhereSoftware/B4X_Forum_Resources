...
Public Sub FetchOpenAd (AppOpenAdUnit As String, CallbackModule As Object, Event As String)
...
Private Sub SetOpenAdCallbackModule(Module As Object, Event As String)
	nativeMe = Me
...
public static class MyAddOpenAdCallback extends AppOpenAdLoadCallback {
	...
	public void onAdFailedToLoad(LoadAdError adError) {
	  ...
	  target.getBA().raiseEventFromDifferentThread(target, null, 0, "event_failedtoreceivead", false, new Object[] {adError.toString(), "AppOpenAd"});		
	}	
    ...
    public void onAdLoaded(AppOpenAd ad) {
		...
		target.getBA().raiseEventFromDifferentThread(target, null, 0, "event_receivead", false, new Object[] {"AppOpenAd"});		
	}
}
