...
Public Sub getShortMessageCommand As Int
	...
	Return mCommand
End Sub
'This was wrong, Data 1 should have returned mMessage(2) etc.  Not going to change it now.

'Obtains the Command data byte in the message.
...
Public Sub getShortMidiStatusByte As Int
	CheckShortMesssage
	Return mMessage(1)
End Sub
'@SLHide
