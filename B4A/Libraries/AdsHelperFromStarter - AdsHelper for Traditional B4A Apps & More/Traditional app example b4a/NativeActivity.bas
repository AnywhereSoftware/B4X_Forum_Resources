...
#if not(test)
	nad.Initialize(Me, "NativeAd2", "ca-app-pub-3940256099942544/1044960115", 0, Activity.Height-200dip, Activity.Width, 200dip, Activity, True, True)
	nad.LoadUnifiedNativeAd
#else
	Dim nad_panel As Panel
	nad_panel.Initialize("")
	Activity.AddView(nad_panel, 0, 0, 100%x, 200dip)
	nad.Initialize(nad_panel, Me)
	nad.LoadNativeAd("NativeAd2", "ca-app-pub-3940256099942544/2247696110")
#end if
