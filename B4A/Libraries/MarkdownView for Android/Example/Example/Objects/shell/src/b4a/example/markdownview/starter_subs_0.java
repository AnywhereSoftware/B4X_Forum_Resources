...
if (RapidSub.canDelegate("application_error")) { return b4a.example.markdownview.starter.remoteMe.runUserSub(false, "starter","application_error", _error, _stacktrace);}
...
if (RapidSub.canDelegate("service_create")) { return b4a.example.markdownview.starter.remoteMe.runUserSub(false, "starter","service_create");}
...
if (RapidSub.canDelegate("service_destroy")) { return b4a.example.markdownview.starter.remoteMe.runUserSub(false, "starter","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return b4a.example.markdownview.starter.remoteMe.runUserSub(false, "starter","service_start", _startingintent);}
...
if (RapidSub.canDelegate("service_taskremoved")) { return b4a.example.markdownview.starter.remoteMe.runUserSub(false, "starter","service_taskremoved");}
