...
public b4a.example.td_swipepanel _td_swipepanel1 = null;
...
RDebugUtils.currentLine=589829;
 //BA.debugLineNum = 589829;BA.debugLine="Private TD_SwipePanel1 As TD_SwipePanel";
_td_swipepanel1 = new b4a.example.td_swipepanel();
...
public String  _td_swipepanel1_scrollchanged(b4a.example.b4xmainpage __ref,int _posx,int _posy) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xmainpage";
if (Debug.shouldDelegate(ba, "td_swipepanel1_scrollchanged", false))
	 {return ((String) Debug.delegate(ba, "td_swipepanel1_scrollchanged", new Object[] {_posx,_posy}));}
RDebugUtils.currentLine=11468800;
 //BA.debugLineNum = 11468800;BA.debugLine="Private Sub TD_SwipePanel1_ScrollChanged(PosX As I";
RDebugUtils.currentLine=11468801;
 //BA.debugLineNum = 11468801;BA.debugLine="Log(PosY & \"/\" & PosY)";
__c.LogImpl("211468801",BA.NumberToString(_posy)+"/"+BA.NumberToString(_posy),0);
