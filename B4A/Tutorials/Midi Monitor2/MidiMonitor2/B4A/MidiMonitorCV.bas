...
Sub Class_Globals
	...
	Private Xui As XUI
	Private SleepTime As Long = 33 ' ~30 FPS
End Sub
...
Public Sub SetSeqr(Seqr As MidiSequencer)
	...
	'We need monitor to add a Metaevent listener so that it can sync the display to the tempo.
'	mSeqr.AddMetaEventListener(Me,"SyncTempo")
