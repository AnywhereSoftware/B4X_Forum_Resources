### Creating MS Word Docx in Android by Johan Schoeman
### 03/22/2026
[B4X Forum - B4A - Tutorials](https://www.b4x.com/android/forum/threads/170655/)

This is an incomplete example - only trying to for now create a basic MS Word \*.docx in android. Note the following:  
  
1. You need to download "poishadow-all.jar from here **<https://github.com/centic9/poi-on-android/releases>**  
2. It uses [USER=448]@agraham[/USER] WriteExternalStorage to add the \*.docx file to File.DirRootExternal (i am not publishing this on playstore so more than happy to use his class and not broken code as what some would like to comment. There is method in the madness for my usage. It works on android 16).  
...
![](https://www.b4x.com/android/forum/attachments/170792)