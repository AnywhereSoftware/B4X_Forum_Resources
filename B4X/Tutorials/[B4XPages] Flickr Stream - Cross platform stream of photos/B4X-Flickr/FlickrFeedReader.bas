...
Private Sub Timer1_Tick
	...
	Dim CurrentIndex As Int = CallSub(mCallback, "GetCurrentIndex")
...
Private Sub DownloadPhoto(fp As FlickrPhoto)
	...
	If j.Success Then
		...
		TrimPhotosCache
		If Timer1.Enabled Then CallSub(mCallback, "NewPhotoAvailable")
	End If
	j.Release
...
Public Sub Start (Callback As Object)
	mCallback = Callback
	Timer1.Enabled = True
End Sub
