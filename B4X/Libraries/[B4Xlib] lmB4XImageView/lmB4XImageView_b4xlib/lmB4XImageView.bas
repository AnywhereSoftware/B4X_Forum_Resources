...
'
'  2.1.2 Fixed a bug
'  2.1.1 Fixed a bug in B4i
'  2.1.0 Fixed a bug in B4i
'
'	2.0.0		04/10/2021
...
#DesignerProperty: Key: BackgroundColor, DisplayName: Background Color, FieldType: Color, DefaultValue: 0x00FFFFFF
...
Public Sub DesignerCreateView (Base As Object, Lbl As Label, Props As Map)
	...
	mBase.AddView(xpnlOver, 0, 0, mBase.Width, mBase.Height)
	Update
End Sub
...
Public Sub Update
	...
	xpnlOver.SetLayoutAnimated(0, iv.Left, iv.Top, iv.Width, iv.Height)
End Sub
...
'Quality: a value between 0 and 100 (max quality).
'Format: "JPEG" or "PNG"
Public Sub SaveBitmap(Dir As String, FileName As String, Quality As Int, Format As String)
...
#If B4J
	Private Sub pnlOver_MouseClicked (EventData As MouseEvent)
		...
		If xui.SubExists(mCallBack, SubFullName, 0) Then
