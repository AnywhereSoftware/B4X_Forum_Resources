...
Sub Class_Globals
	...
	Public TitleBarHeight As Int = 36dip
	Private ButtonWidth As Int = 80dip
	Public Base As B4XView
	Public BackgroundColor As Int = 0xFFF8F9FA 'base panel color - near-white light theme
	Public OverlayColor As Int = 0x88000000
	Public BorderColor As Int = 0xFFDDE1E7
	Public BorderCornersRadius As Int = 10dip
	Public BorderWidth As Int = 1dip
	Public ButtonsColor As Int = 0xFFF0F4FF
	Public ButtonsTextColor As Int = 0xFF5B8DEF
	...
	Public TitleBarColor As Int = 0xFF5B8DEF
	Public TitleBarTextColor As Int
	Public BodyTextColor As Int = 0xFF2D3748 'dark slate - readable on light background
	Public TitleBar As B4XView
	Public PutAtTop As Boolean
	Public TitleBarFont As B4XFont
	Public ButtonsFont As B4XFont
	Public ButtonsTextColorDisabled As Int = 0xFFB0BAC9
...
Public Sub Initialize (Parent As B4XView)
	...
	#End If
	TitleBarFont = xui.CreateDefaultBoldFont(15)
	ButtonsFont = xui.CreateDefaultBoldFont(14)
...
Public Sub ShowCustom (Content As B4XView, Yes As Object, No As Object, Cancel As Object) As ResumableSub
	...
	If IncludeTitle Then
		...
		TitleBar.SetColorAndBorder(TitleBarColor, 0, xui.Color_Transparent, BorderCornersRadius - 2)
...
Private Sub CreateButton (Text As Object, Code As Int)
	...
	xbtn.Tag = Code
	xbtn.SetColorAndBorder(ButtonsColor, 0dip, BorderColor, 8dip)
