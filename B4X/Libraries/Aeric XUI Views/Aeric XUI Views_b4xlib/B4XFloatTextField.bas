...
Version=6.78
@EndOfDesignText@
#DesignerProperty: Key: HintColor, DisplayName: Focused Hint Color, FieldType: Color, DefaultValue: 0xFF5B8DEF
#DesignerProperty: Key: NonFocusedHintColor, DisplayName: Non Focused Hint Color, FieldType: Color, DefaultValue: 0xFF8898AA
