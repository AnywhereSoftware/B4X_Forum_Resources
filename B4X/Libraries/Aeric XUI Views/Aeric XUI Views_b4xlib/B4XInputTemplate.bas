...
Sub Class_Globals
	...
	#End If
	'Private BorderColor As Int = xui.Color_White
	Private BorderColor As Int = xui.Color_LightGray '0xFFD3D3D3
	Private BorderColorInvalid As Int = xui.Color_Red
End Sub
...
Public Sub Initialize
	...
	TextField1.TextColor = xui.Color_Black
	#if B4A
	IME.Initialize("")
...
Private Sub SetBorder (bc As Int)
	#if B4J
	TextField1.SetColorAndBorder(0xFFF0FFFF, 1dip, bc, 2dip)
	#else
