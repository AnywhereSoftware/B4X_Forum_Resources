...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",__ref.getField(false,"_mbuffer" /*RemoteObject*/ ).getField(true,"length"),__ref.getField(true,"_mlength" /*RemoteObject*/ ))) { 
...
try {
		Debug.PushSubsStack("Clear (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("getBuffer (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,96);
...
try {
		Debug.PushSubsStack("getLength (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("IndexOf (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,100);
...
try {
		Debug.PushSubsStack("IndexOf2 (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,105);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_searchfor.getArrayElement(true,BA.numberCast(int.class, _i2)),__ref.getField(false,"_mbuffer" /*RemoteObject*/ ).getArrayElement(true,RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i1),RemoteObject.createImmutable(_i2)}, "+",1, 1)))) { 
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",RemoteObject.createImmutable(_i2),_searchfor.getField(true,"length"))) { 
...
try {
		Debug.PushSubsStack("Insert (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,36);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("g",_index,__ref.getField(true,"_mlength" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 38;BA.debugLine="If Index > mLength Then Log(\"Index too large\")";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_index,__ref.getField(true,"_mlength" /*RemoteObject*/ ))) { 
...
try {
		Debug.PushSubsStack("Remove (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,62);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("k",_endindex,__ref.getField(true,"_mlength" /*RemoteObject*/ ))) { 
...
try {
		Debug.PushSubsStack("Set (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,49);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",RemoteObject.solve(new RemoteObject[] {_data.getField(true,"length"),_index}, "+",1, 1),__ref.getField(true,"_mlength" /*RemoteObject*/ ))) { 
...
try {
		Debug.PushSubsStack("SubArray (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,73);
...
try {
		Debug.PushSubsStack("SubArray2 (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,79);
...
try {
		Debug.PushSubsStack("ToArray (b4xbytesbuilder) ","b4xbytesbuilder",6,__ref.getField(false, "ba"),__ref,90);
