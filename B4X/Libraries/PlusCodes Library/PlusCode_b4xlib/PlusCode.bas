...
#region Doku
'This Is an implementation of the Open Location Code library in B4X.
'
...
'it’s added after the first four characters For short Plus Codes. 
'
...
#region Org VBA Source
'
'https://github.com/google/open-location-code/blob/main/visualbasic/OpenLocationCode.bas
'
'Option Explicit
'
...
'The “+” sign Is added after eight characters of the Plus Code For full codes; 
'it’s added after the first four characters For short Plus Codes. 
'This also makes it possible To quickly see 
'If any characters are missing from the start of a Plus Code And makes the code easy To interpret.
'
'What Is the difference between a Global Plus Code And a short Local Plus Code?
'==============================================================================
'Plus Codes can be written in both global And local form. 
'A full Plus Code Is a "Global Code" such As 7MJCH93V+7F having 8 characters before the “+” sign, 
'While a short Plus Code Is a "Local Code" such As H93V+7F with the first 4 characters dropped.
'
'The code H93V+7F appears in many places across the globe, 
'just As “100 Main Street” may appear in many places across the globe. 
'If you look up H93V+7F on Google Maps, you’ll see the location corresponding To H93V+7F that 
'Is nearest To your location.
'
'Alternatively, you can use the short-form Local Plus Code together 
'with a locality To find a specific location. For example, 
'If you Type “H93V+7F, Kolkata” into Google Maps, you’ll see the nearest location of this code To “Kolkata.” 
'This Is similar To looking up “100 Main Street, Dublin, Ireland” Or “100 Main Street, Boston, USA.” 
'You can think of the first four characters of a Plus Code As similar To the area code of a phone number.
#end region
...
'  
'Code [0] : 8fwc2345+G6
'IsValid, Okay => expected: True, actual: True
'IsShort, Okay => expected: False, actual: False
'IsFull, Okay => expected: True, actual: True
'  
'  
'Code [1] : 8FWC2345+G6G
'IsValid, Okay => expected: True, actual: True
...
'Code [4] : WC2345+G6g
'IsValid, Okay => expected: True, actual: True
'IsShort, Okay => expected: True, actual: True
'IsFull, Okay => expected: False, actual: False
'  
'  
'Code [5] : 2345+G6
'IsValid, Okay => expected: True, actual: True
...
'  
'Code [8] : G+
'IsValid, Okay => expected: False, actual: False
'IsShort, Okay => expected: False, actual: False
'IsFull, Okay => expected: False, actual: False
'  
'  
...
'  
'  
'Encoding test [0] : 7fG49Q00+
'code generation expected: 7fG49Q00+, actual: 7FG49Q00+;
'code recovery expected: 7fG49Q00+, actual: 7FG49Q00+
'coordinate check: 
'	 => given : 20.349999999999994, 2.75 20.399999999999995, 2.8
'	 => expected: " 20.35, 2.75, 20.4, 2.8
'  
'Encoding test [1] : 7FG49QCJ+2v
'code generation expected: 7FG49QCJ+2v, actual: 7FG49QCJ+2V;
'code recovery expected: 7FG49QCJ+2v, actual: 7FG49QCJ+2V
'coordinate check: 
'	 => given : 20.36999999999999, 2.7821250000000077 20.37012499999999, 2.782250000000008
'	 => expected: " 20.37, 2.782125, 20.370125, 2.78225
'  
'Encoding test [2] : 7FG49QCJ+2VX
'code generation expected: 7FG49QCJ+2VX, actual: 7FG49QCJ+2VX;
'code recovery expected: 7FG49QCJ+2VX, actual: 7FG49QCJ+2VW
'coordinate check: 
'	 => given : 20.37009999999999, 2.7821875000000076 20.37012499999999, 2.7822187500000077
'	 => expected: " 20.3701, 2.78221875, 20.370125, 2.78225
'  
'Encoding test [3] : 7FG49QCJ+2VXGJ
'code generation expected: 7FG49QCJ+2VXGJ, actual: 7FG49QCJ+2VXGJ;
'code recovery expected: 7FG49QCJ+2VXGJ, actual: 7FG49QCJ+2VWFH
'coordinate check: 
'	 => given : 20.370111999999992, 2.7822011718750077 20.37011299999999, 2.7822031250000077
'	 => expected: " 20.370113, 2.782234375, 20.370114, 2.78223632813
'  
'Encoding test [4] : 8FVC2222+22
'code generation expected: 8FVC2222+22, actual: 8FVC2222+22;
'code recovery expected: 8FVC2222+22, actual: 8FVC2222+22
'coordinate check: 
'	 => given : 47.0, 8.0 47.000125, 8.000125
'	 => expected: " 47.0, 8.0, 47.000125, 8.000125
'  
'Encoding test [5] : 4VCPPQGP+Q9
'code generation expected: 4VCPPQGP+Q9, actual: 4VCPPQGP+Q9;
'code recovery expected: 4VCPPQGP+Q9, actual: 4VCPPQGP+Q9
'coordinate check: 
'	 => given : -41.273125, 174.78587500000003 -41.273, 174.78600000000003
'	 => expected: " -41.273125, 174.785875, -41.273, 174.786
'  
'Encoding test [6] : 62G20000+
'code generation expected: 62G20000+, actual: 62G20000+;
'code recovery expected: 62G20000+, actual: 62G20000+
'coordinate check: 
'	 => given : 0.0, -180.0 1.0, -179.0
'	 => expected: " 0.0, -180.0, 1.0, -179.0
'  
'Encoding test [7] : 22220000+
'code generation expected: 22220000+, actual: 22220000+;
'code recovery expected: 22220000+, actual: 22220000+
'coordinate check: 
'	 => given : -90.0, -180.0 -89.0, -179.0
'	 => expected: " -90.0, -180.0, -89.0, -179.0
'  
'Encoding test [8] : 7FG40000+
'code generation expected: 7FG40000+, actual: 7FG40000+;
'code recovery expected: 7FG40000+, actual: 7FG40000+
'coordinate check: 
'	 => given : 20.0, 2.0 21.0, 3.0
'	 => expected: " 20.0, 2.0, 21.0, 3.0
'  
'Encoding test [9] : 22222222+22
'code generation expected: 22222222+22, actual: 22222222+22;
'code recovery expected: 22222222+22, actual: 22222222+22
'coordinate check: 
'	 => given : -90.0, -180.0 -89.999875, -179.999875
'	 => expected: " -90.0, -180.0, -89.999875, -179.999875
'  
'Encoding test [10] : 6VGX0000+
'code generation expected: 6VGX0000+, actual: 6VGX0000+;
'code recovery expected: 6VGX0000+, actual: 6VGX0000+
'coordinate check: 
'	 => given : 0.0, 179.0 1.0, 180.0
'	 => expected: " 0.0, 179.0, 1.0, 180.0
'  
'Encoding test [11] : CFX30000+
'code generation expected: CFX30000+, actual: CFX30000+;
'code recovery expected: CFX30000+, actual: CFX30000+
'coordinate check: 
'	 => given : 89.0, 1.0 90.0, 2.0
'	 => expected: " 89.0, 1.0, 90.0, 2.0
'  
'Encoding test [12] : CFX30000+
'code generation expected: CFX30000+, actual: CFX30000+;
'code recovery expected: CFX30000+, actual: CFX30000+
'coordinate check: 
'	 => given : 89.0, 1.0 90.0, 2.0
'	 => expected: " 89.0, 1.0, 90.0, 2.0
'  
'Encoding test [13] : 62H20000+
'code generation expected: 62H20000+, actual: 62H20000+;
'code recovery expected: 62H20000+, actual: 62H20000+
'coordinate check: 
'	 => given : 1.0, -180.0 2.0, -179.0
'	 => expected: " 1.0, -180.0, 2.0, -179.0
'  
'Encoding test [14] : 62H30000+
'code generation expected: 62H30000+, actual: 62H30000+;
'code recovery expected: 62H30000+, actual: 62H30000+
'coordinate check: 
'	 => given : 1.0, -179.0 2.0, -178.0
'	 => expected: " 1.0, -179.0, 2.0, -178.0
'  
'Shorten test 0, expected: +2VX, actual: +2VX
'Recover test 0, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 1, expected: CJ+2VX, actual: CJ+2VX
'Recover test 1, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 2, expected: CJ+2VX, actual: CJ+2VX
'Recover test 2, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 3, expected: CJ+2VX, actual: +2VX
'Recover test 3, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 4, expected: CJ+2VX, actual: CJ+2VX
'Recover test 4, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 5, expected: 9QCJ+2VX, actual: 9QCJ+2VX
'Recover test 5, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 6, expected: 9QCJ+2VX, actual: 9QCJ+2VX
'Recover test 6, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 7, expected: 9QCJ+2VX, actual: 9QCJ+2VX
'Recover test 7, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 8, expected: 9QCJ+2VX, actual: 9QCJ+2VX
'Recover test 8, expected: 9C3W9QCJ+2VX, actual: 9C3W9QCJ+2VW
'  
'Shorten test 9, expected: 22+, actual: 22+
'Recover test 9, expected: 8FJFW222+, actual: 8FJFW222+
'  
'Shorten test 10, expected: 22+, actual: 22+
'Recover test 10, expected: 796RXG22+, actual: 796RXG22+
'  
'North pole recovery test, expected: CFX22222+22, actual: CFX22222+22
'  
'South pole recovery test, expected: 2CXXXXXX+XX, actual: 2CXXXXXX+XX
'All tests finished, check Log output If passed
#end region

'Click To build b4xlib: ide://run?file=%JAVABIN%\jar.exe&WorkingDirectory=..&Args=-cMf&Args=PlusCode.b4xlib&&Args=..&Args=PlusCode.bas&Args=manifest.txt

Sub Class_Globals
	
	'The Max number of digits To process in a plus code.
	Public const MAX_DIGIT_COUNT_ As Int = 15
	
	' Provides the length of a normal precision code, approximately 14x14 meters.
	Public Const CODE_PRECISION_NORMAL_ As Int = 10

	' Provides the length of an extra precision code, approximately 2x3 meters.
	Public Const CODE_PRECISION_EXTRA_ As Int = 11

	' The structure returned when decoding.
	Type OLCArea (LatLo As Double, LngLo As Double, LatHi As Double, LngHi As Double, LatCenter As Double, LngCenter As Double, CodeLength As Int)

	' A separator used to break the code into two parts to aid memorability.
	Private Const SEPARATOR_ As String = "+"

	' The number of characters to place before the separator.
	Private Const SEPARATOR_POSITION_ As Int = 8
	...
	' The base to use to convert numbers to/from.
	Private Const ENCODING_BASE_ As Int = 20
	...
	' code is approximately 13x13 meters (at the equator), and should be suitable
	' for identifying buildings. This excludes prefix and separator characters.
	Private Const PAIR_CODE_LENGTH_ As Int = 10

	' Number of columns in the grid refinement method.
	Private Const GRID_COLUMNS_ As Int = 4

	' Number of rows in the grid refinement method.
	Private Const GRID_ROWS_ As Int = 5

	' Size of the initial grid in degrees.
	Private Const GRID_SIZE_DEGREES_ As Double = 1 / 8000

	' Minimum length of a code that can be shortened.
	Private Const MIN_TRIMMABLE_CODE_LEN_ As Int = 6
...
' If the code is padded, there must be an
' even number of digits before the padded section, an even number of padding
' characters, followed only by a single separator.
public Sub OLCIsValid(code As String) As Boolean
	Private separatorPos, paddingStart As Int
	code=code.ToUpperCase
	separatorPos = code.IndexOf(SEPARATOR_)
	paddingStart = code.IndexOf(PADDING_CHARACTER_)
	' code must not be empty
	If code = "" Then Return False
	' Separator is required because of naming PLUSCode, changed 2018 !!!  only if shorten not true 
	If separatorPos < 0 Then Return False										
	' Must be only one separator.
	If code.IndexOf2(SEPARATOR_,separatorPos + 1) > -1 Then Return False		
	' Is the separator the only character?
	If code.Length = 1 Then  Return False										
	' The separator is in an illegal position.
	If separatorPos > SEPARATOR_POSITION_ + 1 Or (separatorPos Mod 2) = 1 Then  Return False  
	' Must be more than one character after the separator if no padding.
	' Since 2018 changed 
	' 11223344+  length = 9, separatorPos=8  okay  9-8=1
	' 11223344+G  length =10, separatorPos8  failed  10-8=2
	' 11223344+G1  length =11, separatorPos8  okay  11-8=3
	If code.Length - separatorPos = 2 Then  Return False

	If paddingStart > -1 Then 
		' Short codes cannot have padding, short codes separator position < 8, SEPARATOR_POSITION_
		If separatorPos < SEPARATOR_POSITION_ Then Return False					
		' Cannot start with padding characters, pos 0 or pos 1.
		If paddingStart < 2 Then Return False									
		' Padding characters must be after an even number of digits.
		If (paddingStart Mod 2) = 1 Then  Return False							
		' Padded codes must not have anything after the separator.
		' separator is last character of code, position 8, length = lastposition+1 !!
		If code.Length > (separatorPos+1) Then  Return False						
		' Get from the first padding character to the separator. to make sure no other charakters than 
		' Padding charakter from paddingstart to separartor forms the code string
		Private paddingSection As String
		paddingSection = code.SubString2(paddingStart, separatorPos)
		paddingSection = paddingSection.Replace(PADDING_CHARACTER_, "")
		' After removing padding characters, we mustn't have anything left.
		If paddingSection <> "" Then Return False
	End If
	
	' If the structural checks pass, check all characters are valid.
	Private i As Int
	Private c As Char
	Private Code_Extend As String  = CODE_ALPHABET_ & PADDING_CHARACTER_ &SEPARATOR_
	For i = 0 To code.Length-1
		c = code.CharAt(i)
		If Code_Extend.Contains(c)=False Then Return False
	Next
	Return True
End Sub
...
' Determines if a code is a valid short code.
' make use of IsValid
public Sub OLCIsShort(code As String) As Boolean
	Private separatorpos As Int  = code.IndexOf(SEPARATOR_)
	If OLCIsValid(code)=False Then Return False
	If separatorpos=0 And code.Length>1 Then Return True
	Return  OLCIsValid(code) And (separatorpos>=1) And (separatorpos < SEPARATOR_POSITION_)' And (code.Contains(PADDING_CHARACTER_&PADDING_CHARACTER_)=False)
End Sub

' Determines if a code is a valid full Open Location Code.
' make use if IsValid and IsShort
public Sub OLCIsFull(code As String) As Boolean
	code = code.ToUpperCase
	If code.Length < 2 Then Return False
	If code.CharAt(0)=SEPARATOR_ Then Return False
	If OLCIsValid(code)=False Then Return False
	If OLCIsShort(code) Then Return False
	' Work out what the first two characters indicate for latitude and longitude.
	Return (CODE_ALPHABET_.IndexOf(code.CharAt(0)) * ENCODING_BASE_ < LATITUDE_MAX_ * 2) Or _ 
					(CODE_ALPHABET_.IndexOf(code.CharAt(1)) * ENCODING_BASE_ < LONGITUDE_MAX_ * 2)
End Sub


' Encode a location into an arbitrary precision Open Location Code.
public Sub OLCEncode(latitude As Double, longitude As Double, codeLength As Int) As String

	Private lat, lng As Double
	Private latCode, lngCode, gridCode As String
	Private code As String

	'Check codelength
	If codeLength = 0 Then
		codeLength = CODE_PRECISION_NORMAL_
	End If
	codeLength = Min(codeLength, MAX_DIGIT_COUNT_)
	If (codeLength < PAIR_CODE_LENGTH_ And codeLength Mod 2 = 1 Or codeLength < 4)Then
		'Err.raise vbObjectError + 513, "OLCEncodeWithLength", "Invalid code length"
		#if B4J 
			LogError("Error OLCEncode Invalid code length")
		#End If
	End If
	...
	' Latitude 90 needs to be adjusted to be just under, so the returned code can also be decoded.
	If lat = 90 Then
		'lat = lat - 0.9 * computeLatitudePrecision(codeLength)   'java
		lat = lat - computeLatitudePrecision(codeLength)
	End If
	...
	latCode = encodeCoordinate(lat + LATITUDE_MAX_, Min(codeLength, PAIR_CODE_LENGTH_) / 2)
	lngCode = encodeCoordinate(lng + LONGITUDE_MAX_, Min(codeLength, PAIR_CODE_LENGTH_) / 2)
...
' Decodes an Open Location Code into an array of latlo, lnglo, latcenter, lngcenter, lathi, lnghi, codelength.
public Sub OLCDecode2Array(code As String) As List
	Private codeArea As OLCArea
	codeArea = OLCDecode(code)
	Private result As List
	result.Add(codeArea.LatLo)
	result.Add(codeArea.LngLo)
	result.Add(codeArea.LatCenter)
	result.Add(codeArea.LngCenter)
	result.Add(codeArea.LatHi)
	result.Add(codeArea.LngHi)
	result.Add(codeArea.CodeLength)
	Return result
End Sub

public Sub OLCDecode(code As String) As OLCArea
	Private codeArea As OLCArea
	codeArea.Initialize
	If OLCIsFull(code)=False Then
		#if B4j
			LogError("Error OLCDecode Isfull")
		#End If
		'Err.raise vbObjectError + 513, "OLCDecode", "Invalid code"
		Return codeArea   
	End If 
	...
	' valid so the maximum is one), padding characters and convert to upper
	' case.
	c = code.Replace(SEPARATOR_, "")
	c = c.Replace(PADDING_CHARACTER_, "")
	c = c.ToUpperCase
	' Decode the lat/lng pairs.
	codeArea = decodePairs(c.SubString2(0,Min(PAIR_CODE_LENGTH_,c.Length)))
	' If there is a grid refinement component, decode that.
	If c.Length > PAIR_CODE_LENGTH_ Then
		Private gridArea As OLCArea
		gridArea = decodeGrid(c.SubString(PAIR_CODE_LENGTH_))
		codeArea.LatHi = codeArea.LatLo + gridArea.LatHi
		codeArea.LngHi = codeArea.LngLo + gridArea.LngHi
		codeArea.LatLo = codeArea.LatLo + gridArea.LatLo
		codeArea.LngLo = codeArea.LngLo + gridArea.LngLo
	...
	codeArea.LatCenter = (codeArea.LatLo + codeArea.LatHi) / 2
	codeArea.LngCenter = (codeArea.LngLo + codeArea.LngHi) / 2
	codeArea.CodeLength = c.Length
	Return codeArea
End Sub

' Remove characters from the start of an OLC code based on a reference location.
public Sub OLCShorten(code As String, latitude As Double, longitude As Double) As String
	If OLCIsValid(code)=False Then
		'Err.raise vbObjectError + 513, "OLCDecode", "Invalid code"
		#if B4j 
			LogError("Error OLCShorten isvalid")
		#End If
	End If 
	If code.IndexOf(PADDING_CHARACTER_) <> -1 Then
		'Err.raise vbObjectError + 513, "OLCDecode", "Invalid code"
		#if B4j
			LogError("Error OLCShorten isshorten")
		#End If
	End If
	Private codeArea As OLCArea
	codeArea = OLCDecode(code)
	If codeArea.CodeLength < MIN_TRIMMABLE_CODE_LEN_ Then
		'Err.raise vbObjectError + 513, "OLCDecode", "Invalid code"
		#if B4j
			LogError("Error minlength to trim")
		#End If
	End If
	Private lat, lng, range, precision As Double
	Private i, trim As Int
	' Ensure that the latitude and longitude are valid.
	lat = clipLatitude(latitude)
	lng = normalizeLongitude(longitude)
	' How close are the latitude and longitude to the code center?
	range = Max(Abs(codeArea.LatCenter - lat),Abs(codeArea.LngCenter - lng))
	precision = ENCODING_BASE_
	For i = 0 To 3
		If range < precision * 0.3 Then
			trim = (i + 1) * 2
		End If
		precision = precision / ENCODING_BASE_
	Next
	Return code.SubString(trim).ToUpperCase
End Sub

' Recover the nearest matching code to a specified location.
public Sub OLCRecoverNearest(code As String, latitude As Double, longitude As Double) As String
	If OLCIsFull(code) Then
		#if B4j
			LogError($"Error OLCRecover isFull only pass a shortcode : ${code}"$)
		#else
			Log ($"Error OLCRecover isFull only pass a shortcode : ${code}"$)
		#End If
		Return code
	else if OLCIsShort(code)=False Then
		'Err.raise vbObjectError + 513, "OLCDecode", "Invalid code"
		#if B4j
			LogError($"Error OLCRecover isShort only pass a shortcode : ${code}"$)
		#else
			Log ($"Error OLCRecover isShort only pass a shortcode : ${code}"$)
		#End If
		Return code  
	Else
		Private lat, lng, resolution, halfRes As Double
		Private paddingLength As Int
		Private codeArea As OLCArea
		codeArea.Initialize
		' Ensure that the latitude and longitude are valid.
		lat = clipLatitude(latitude)
		lng = normalizeLongitude(longitude)
		' Compute the number of digits we need to recover.
		paddingLength = SEPARATOR_POSITION_ - code.IndexOf( SEPARATOR_)
		' The resolution (height and width) of the padded area in degrees.
		resolution = Power(ENCODING_BASE_ ,(2 - (paddingLength / 2)))
		' Distance from the center to an edge (in degrees).
		halfRes = resolution / 2
		' Use the reference location to pad the supplied short code and decode it.
		'Log (OLCEncode(lat, lng,0).SubString2(0, paddingLength))
		codeArea = OLCDecode(OLCEncode(lat, lng,0).SubString2(0, paddingLength) & code)
		' How many degrees latitude is the code from the reference? If it is more
		' than half the resolution, we need to move it nort or south but keep it
		' within -90 to 90 degrees.
		If lat + halfRes < codeArea.LatCenter And codeArea.LatCenter - resolution > LATITUDE_MAX_ Then
			...
			' it's too far, and the best match will be one cell south.
			codeArea.LatCenter = codeArea.LatCenter - resolution
		else if lat - halfRes > codeArea.LatCenter And codeArea.LatCenter + resolution < LATITUDE_MAX_ Then
			' If the proposed code is more than half a cell south of the reference location,
			' it's too far, and the best match will be one cell north.
			codeArea.LatCenter = codeArea.LatCenter + resolution
		End If
		...
		If lng + halfRes < codeArea.LngCenter Then
			codeArea.LngCenter = codeArea.LngCenter - resolution
		else if lng - halfRes > codeArea.LngCenter Then
			codeArea.LngCenter = codeArea.LngCenter + resolution
		End If
		Return OLCEncode(codeArea.LatCenter, codeArea.LngCenter, codeArea.CodeLength)
	End If 
End Sub

' Clip a latitude into the range -90 to 90.
private Sub clipLatitude(latitude As Double) As Double
	If latitude >= -90 Then
		If latitude <= 90 Then
			Return latitude
		Else
...
' Normalize a longitude into the range -180 to 180, not including 180.
private Sub normalizeLongitude(longitude As Double) As Double
...
' lengths > 10 have different precisions due to the grid method having
' fewer columns than rows.
private Sub computeLatitudePrecision(codeLength As Int) As Double
	If codeLength <= 10 Then
		Return Power(ENCODING_BASE_ , (codeLength / -2 + 2))
	Else
		Return Power(ENCODING_BASE_ ,-3) / Power(GRID_ROWS_ , (codeLength - 10))
	End If
End Sub

' Merge code parts into a single code.
private Sub mergeCode(latCode As String, lngCode As String, gridCode As String) As String
	Private code As String
	Private i, digitCount As Int
	code = ""
	digitCount = 0
	For i = 0 To latCode.Length-1
		code = code & latCode.CharAt(i)
		code = code & lngCode.CharAt(i)
		digitCount = digitCount + 2
		If digitCount = SEPARATOR_POSITION_ Then
			code = code & SEPARATOR_
		End If
	Next
	Do While code.Length < SEPARATOR_POSITION_
		code = code & PADDING_CHARACTER_
	Loop
	If code.Length = SEPARATOR_POSITION_ Then
		code = code & SEPARATOR_
	End If
	code = code & gridCode
	Return code
...
' Encode a coordinate into an OLC sequence.
private Sub encodeCoordinate(degrees As Double, digits As Int) As String
	Private code As String
	Private remaining, precision As Double
	Private i As Int
	code = ""
	remaining = degrees
	precision = ENCODING_BASE_
	For i = 1 To digits
		Private digitValue As Int
		' Get the latitude digit.
		digitValue = remaining / precision
		remaining = remaining - digitValue * precision
		code = code & CODE_ALPHABET_.CharAt(digitValue)
		precision = precision / ENCODING_BASE_
	Next
	Return code
End Sub
	...
	' Decode an OLC code made up of lat/lng pairs.
private Sub decodePairs(code As String) As OLCArea
	Private lat, lng, precision As Double
	Private offset As Int
	lat = 0
	lng = 0
	precision = ENCODING_BASE_
	offset = 0
	Do While offset < code.Length
		Private c As Char
		' Get the lat digit.
		c = code.CharAt(offset)
		lat = lat + (CODE_ALPHABET_.IndexOf(c)) * precision
		' Get the lng digit.
		offset = offset + 1
		c = code.CharAt(offset)
		lng = lng + (CODE_ALPHABET_.IndexOf(c)) * precision
		'Next pair
		offset = offset + 1
	...
	codeArea.LatHi = codeArea.LatLo + precision
	codeArea.LngHi = codeArea.LngLo + precision
	codeArea.CodeLength = code.Length
	Return codeArea
End Sub
...
' to be refined with just a single character.
' This algorithm is used for codes longer than 10 digits.
private Sub encodeGrid(latitude As Double, longitude As Double, codeLength As Int) As String
	Private code As String
	Private latPlaceValue, lngPlaceValue, lat, lng As Double
	...
	For i = 0 To codeLength-1
		' Work out the row and column.
		row = lat / (latPlaceValue / GRID_ROWS_)
		col = lng / (lngPlaceValue / GRID_COLUMNS_)
		latPlaceValue = latPlaceValue / GRID_ROWS_
		lngPlaceValue = lngPlaceValue / GRID_COLUMNS_
		lat = lat - row * latPlaceValue
		lng = lng - col * lngPlaceValue
		'Log ($"CharAt : ${row * GRID_COLUMNS_ + col}"$)
		code = code & CODE_ALPHABET_.CharAt(row * GRID_COLUMNS_ + col)
	Next
	Return code
End Sub

' Decode the grid refinement portion of an OLC code.
private Sub decodeGrid(code As String) As OLCArea
	Private gridOffSet As OLCArea
	Private latVal, lngVal As Double
	Private i, d, row, col As Int
	latVal = GRID_SIZE_DEGREES_
	lngVal = GRID_SIZE_DEGREES_
	For i = 0 To code.Length-1
'		d = code.SubString2(i, 1).IndexOf(CODE_ALPHABET_) - 1
		d = CODE_ALPHABET_.IndexOf(code.CharAt(i))-1
		row = (d / GRID_COLUMNS_).As (Int)
		col = d Mod GRID_COLUMNS_
		latVal = latVal / GRID_ROWS_
		lngVal = lngVal / GRID_COLUMNS_
		gridOffSet.LatLo = gridOffSet.LatLo + row * latVal
...
' Provide a mod function.
' (In OpenOffice Basic the Mod operator only works with Integers.)
private Sub doubleMod(number As Double, divisor As Double) As Double
	Return number - divisor * (number / divisor).As (Int)
End Sub
