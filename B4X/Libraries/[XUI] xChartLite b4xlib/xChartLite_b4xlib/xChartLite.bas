...
'
'Version 1.4
'Amended problem with display values in BAR and STACKED_BAR charts
'
'Version 1.3
...
Sub Class_Globals
	...
	Type NumberFormatsL(MinimumIntegers As Int, MaximumFractions As Int, MinimumFractions As Int, GroupingUsed As Boolean)
	...
	Private BMVNF As NumberFormatsL		' Bar Mean Value Number Format
...
Public Sub AddPie(Name As String, Value As Float, Color As Int)
	If WrongChartType("PIE") Then Return
...
Public Sub DrawChart
	If AlreadyWrongChartType Then Return
...
Public Sub setMaxDigits(MaxDigits As Int)
	Values.MaxDigits = Min(10, Max(6, MaxDigits))
	If Points.Size > 0 Then
		InitValues
	End If
End Sub
