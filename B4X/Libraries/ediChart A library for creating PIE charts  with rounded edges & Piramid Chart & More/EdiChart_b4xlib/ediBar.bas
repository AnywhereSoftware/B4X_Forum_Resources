...
Private Sub DrawValue(Value As Float)
	...
	#End If
		...
		For i=listaFinale.Size-1 To 0 Step -1'listaFinale.Size-1
			...
			Rhombus.LineTo(larghezza*(i+2)+0.5*larghezza/3, bc.mHeight-13dip)
			Rhombus.LineTo(larghezza*(i+2)+0.5*larghezza/3, bc.mHeight- valorelunghezza-  larghezza/3/2)
			...
			Rhombus.LineTo(larghezza*(i+2)+larghezza/3,bc.mHeight-13dip)
			Rhombus.LineTo(larghezza*(i+2)+larghezza/3, bc.mHeight- valorelunghezza-  larghezza/10)
			Rhombus.LineTo(larghezza*(i+2)+0.5*larghezza/3, bc.mHeight- valorelunghezza-  larghezza/3/2)
...
'		
			...
			If Percentuale=True Then
				canvas.DrawText(text, rect.CenterX+larghezza/4, bc.mHeight - valorelunghezza-larghezza/4, Font1, xui.Color_Black, "CENTER")
			End If
