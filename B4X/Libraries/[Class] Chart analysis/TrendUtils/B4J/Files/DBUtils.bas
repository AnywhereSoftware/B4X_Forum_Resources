...
''Executes the query and fills the ComboBox with the values in the first column
'Sub ExecuteComboBox(SQL As SQL, Query As String, StringArgs() As String, Limit As Int, Spinner1 As B4XComboBox)
'	Dim Table As List
'	Table = ExecuteMemoryTable(SQL, Query, StringArgs, Limit)
'	Dim Cols() As String, L As List
'	L.Initialize
...
Sub SetRowCount(rs As JavaObject) As Int
