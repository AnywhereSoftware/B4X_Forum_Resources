...
@interface b4i_cornereffectbackground : B4IClass
{
@public B4IXUI* __xui;
...
- (NSString*)  _createcorner:(B4XCanvas*) _can :(int) _width :(int) _height :(int) _cornerradius :(int) _color :(int) _depth;
- (NSString*)  _createpathcorner:(B4XCanvas*) _can :(B4IArray*) _listpoint :(B4IArray*) _list2 :(int) _edge :(int) _color :(int) _background :(float) _degree;
...
- (NSString*)  _effectcornertoview:(B4XViewWrapper*) _vw :(NSString*) _effect :(int) _cornercolor :(int) _backgroundcolor :(int) _depthedge :(int) _cornerradius;
- (B4IArray*)  _exagonlist:(float) _width :(float) _height :(int) _depthedge :(int) _rcs;
- (B4XBitmapWrapper*)  _generatecornereffect:(B4XViewWrapper*) _vw :(NSString*) _effect :(int) _cornercolor :(int) _backgroundcolor :(int) _depthedge :(int) _cornerradius;
...
@class _sepoint;
@class b4i_shadoweffectbackground;
@class b4i_cornereffectbackground;
