...
Sub Class_Globals
	...
	'Private Endpoint As String = "opc.tcp://192.168.0.143:4840/"
	'Private Endpoint As String = "opc.tcp://localhost:4840/"
	Private Endpoint As String = "opc.tcp://192.168.0.189:4840/"
...
Sub Connect_Anonymous_With_Certificate
	Dim p12 As String = File.Combine(XUI.DefaultFolder, "clientcert.p12")
...
Sub Connect_AutoSecure_With_Certificate
	Dim p12Path As String = File.Combine(XUI.DefaultFolder, "clientcert.p12")
