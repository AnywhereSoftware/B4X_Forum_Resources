###  B4J/B4A: OPC UA industrial client library - Connect to servers / devices by Peter Simpson
### 09/18/2026
[B4X Forum - B4X - Libraries](https://www.b4x.com/android/forum/threads/171977/)

Hello everyone,  
Here is my OPC UA Client library for B4J/B4A. I use this library to connect to OPC UA servers for testing, development, and general industrial communication work. It is designed to be simple to use, reliable, and fully compatible with standard OPC UA servers, compatible hardware devices and machinery, including my own B4J OPC UA Server library.  
...
This client implementation is ideal for connecting to and testing OPC UA servers, building industrial dashboards, monitoring machine data, or integrating OPC UA communication into your B4J/B4A applications.  
  
**B4J Library Tab**  
![](https://www.b4x.com/android/forum/attachments/173414)  
  
**B4A Library Tab**  
![](https://www.b4x.com/android/forum/attachments/173689)  
...
**B4A test applications**  
![](https://www.b4x.com/android/forum/attachments/173687)  
